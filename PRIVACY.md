...
Darkframe does not collect, transmit, or store any user data, browsing history, or page
...
any Darkframe-controlled server anywhere in this codebase.
...
account, not via Darkframe).

## Third parties

Darkframe has no third-party dependencies that transmit data at runtime. Build-time developer
